...
[![License: Custom](https://img.shields.io/badge/license-personal--use--only-red)](https://github.com/MarKusYt786/YKs.GitHub.io/blob/main/LICENSE)
[![Live Demo](https://img.shields.io/badge/Live%20Demo-techinz.dev-purple?style=flat-square)](https://techinz.dev)
[![Hours Spent](https://img.shields.io/badge/Hours%20Spent-250%2B-blue?style=flat-square)](https://github.com/MarKusYt786/YKs.GitHub.io)
...
1. **Clone the repo:**
    ```bash
    git clone https://github.com/MarKusYt786/YKs.GitHub.io.git
    cd YKs.GitHub.io
    ```
...
- **LinkedIn:** [Yeswanth Ketha](hwww.linkedin.com/in/yeswanth-ketha-95b864246)
...
- Star it on [GitHub](https://github.com/MarKusYt786/YKs.GitHub.io)
